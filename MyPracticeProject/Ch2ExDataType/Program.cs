...
namespace Ch2ExDataType
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            int myIndex = firstString.ToLower().IndexOf(searchWord.ToLower());
            Console.WriteLine(searchWord + " is in position " + myIndex + " and the length is " + searchWord.Length);
        }
    }
}
